...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("User Login BIN");
        getSupportActionBar().setSubtitle("Badan Intelejen Nasional");
    }
    public void loginMasuk(final String field, final String password) {
       ...
       // editText1 = (EditText) findViewById(R.id.edittext_username);
        ...
        //if ((text1.contains("admin")) && ((text2.contains("qwerty")))) {
